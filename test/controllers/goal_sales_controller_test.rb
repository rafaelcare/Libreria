...
class GoalSalesControllerTest < ActionController::TestCase
  ...
  test "should create goal_sale" do
    assert_difference('GoalSale.count') do
      post :create, goal_sale: { alcanzado: @goal_sale.alcanzado, fechafin: @goal_sale.fechafin, fechainicio: @goal_sale.fechainicio, meta: @goal_sale.meta, usuario_id: @goal_sale.usuario_id }
    end
  ...
  test "should update goal_sale" do
    patch :update, id: @goal_sale, goal_sale: { alcanzado: @goal_sale.alcanzado, fechafin: @goal_sale.fechafin, fechainicio: @goal_sale.fechainicio, meta: @goal_sale.meta, usuario_id: @goal_sale.usuario_id }
    assert_redirected_to goal_sale_path(assigns(:goal_sale))
  end
